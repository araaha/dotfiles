 ...
 * default) */
static const char *WIN_BG[] = {"Nsxiv.window.background", "#242424"};
static const char *WIN_FG[] = {"Nsxiv.window.foreground", "#ebdbb2"};
static const char *MARK_FG[] = {"Nsxiv.mark.foreground", NULL};
#if HAVE_LIBFONTS
static const char *BAR_BG[] = {"Nsxiv.bar.background", "#242424"};
static const char *BAR_FG[] = {"Nsxiv.bar.foreground", NULL};
static const char *BAR_FONT[] = {"Nsxiv.bar.font", "MesloLGS NF Regular 12"};
...
static const float zoom_levels[] = {
    ...
    140, 150, 160, 170,  180,  190,  200,  220,  240,  260,  280,  300, 400,
    500, 600, 800, 1000, 1300, 1600, 2000, 2500, 3000, 3500, 4000, 4500};
...
static const keymap_t keys[] = {
    ...
    {0, XK_H, t_move_file, -1},
    {0, XK_J, t_move_file, DIR_DOWN},
    {0, XK_K, t_move_file, DIR_UP},
    {0, XK_L, t_move_file, +1},
    {ControlMask, XK_r, t_rename_ordered, None},
