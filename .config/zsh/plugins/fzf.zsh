...
export FZF_DEFAULT_OPTS="--no-scrollbar --border=bold --no-separator  --tiebreak=length,end --padding 0% --margin 0% --multi --reverse --preview-window=border-none --height=50%
