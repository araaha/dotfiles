...
local options = {
    ...
    -- Categories to fetch
    categories = "sponsor,intro,outro,interaction,selfpromo,music_offtopic,preview",

    -- Categories to skip automatically
    skip_categories = "sponsor,intro,outro,interaction,selfpromo,music_offtopic,preview",
